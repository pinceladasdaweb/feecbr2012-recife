...
SlideDeck.prototype.loadConfig_ = function(config) {
  ...
  if (this.config_.presenters) {
    ...
    if (presenters.length == 1) {
	  ...
	  var facebook = p.facebook ? '<span>facebook</span>' +
      ...
      var github = p.github ? '<span>github</span><a href="https://github.com/' + p.github +
          '">' + p.github.replace(/https?:\/\//, '') + '</a>' : '';

      var html2 = [gplus, twitter, facebook, github, www].join('<br>');
